...
총액이 맞는다고 일별 원장까지 완전히 맞는 것은 아닙니다. 일별 재구성 잔액과 마지막 표시 잔액이 다른 날은 154일이고 최대 차이는 1.0012 BTC입니다. 시간 정보 손실, 동일 정산 묶음의 잔액 반복, 날짜 순서 역전, 일부 숫자의 정밀도 손실을 그대로 공개했습니다. [방법론](../research/methodology.ko.md)에서 확인할 수 있습니다.
...
평균단가 모델과 지갑 XBTUSD 실현손익 사이에 **0.02745234 BTC** 차이가 남습니다. 구간 통계는 펀딩을 제외하며 최종 미종료 구간도 승패에서 제외합니다. 다른 계약이 헤지 역할을 했을 가능성도 있어, 이 적중률을 확정된 실전 매매 승률로 표현하지 않습니다.
